...
from permpy import PegPermutation, PermSet
from permpy.vectorset import VectorSet
...
class PegPermSet(PermSet):
    ...
    def alt_enumerate(self, cross_sections=None):
        # only works when the set is a generating set for sortables and the top layer
        # has all the same length!
