# TODO: missing some function `compositions`
...
def gen_interval_divisions(m, k, shift=0, reverse=False):
    """
    Generate all ways of splitting the interval `[1, m]` shifted up by `shift` into
    `k` pieces.
...
if __name__ == "__main__":
    ...
    #         if 0 <= idx <= n:
    #             print("cells = {:2}, n = {:2}, grids = {:8}, perms = {:8}".format(
    #                 total_cells, idx, D[idx], C[idx])
    #             )
