    ...
    for i in range(0,d):
      ...
      for P in copy:
        ...
        for indices in combinations_with_replacement(range(0, n), 3):
          ...
          entries = PP[:indices[0]+1] + PP[indices[1]+2:indices[2]+3] + PP[indices[0]+1:indices[1]+2] + PP[indices[2]+3:]
          signs = PP.signs[:indices[0]] + PP.signs[indices[1]+1:indices[2]+2] + PP.signs[indices[0]:indices[1]+1] + PP.signs[indices[2]+2:]
    ...
    for i in range(0,d):
      ...
      for P in copy:
        ...
        for indices in combinations_with_replacement(range(0, n), 2):
          ...
          entries = PP[indices[0]+1:indices[1]+2] + PP[:indices[0]+1] + PP[indices[1]+2:]
          signs = PP.signs[indices[0]+1:indices[1]+2] + PP.signs[:indices[0]+1] + PP.signs[indices[1]+2:]
    ...
    for i in range(0,d):
      ...
      for P in copy:
        ...
        for indices in combinations_with_replacement(range(0, n), 2):
          ...
          entries = PP[:indices[0]+1] + PP[indices[0]+1:indices[1]+2][::-1] + PP[indices[1]+2:]
          signs = PP.signs[:indices[0]+1] + PegPermSet.flip_signs(PP.signs[indices[0]+1:indices[1]+2][::-1]) + PP.signs[indices[1]+2:]
    ...
    for i in range(0,d):
      ...
      for P in copy:
        ...
        for indices in combinations_with_replacement(range(0, n), 1):
          ...
          signs = PegPermSet.flip_signs(PP.signs[:indices[0]+1][::-1]) + PP.signs[indices[0]+1:]
    ...
    for i in range(0,d):
      ...
      for P in copy:
        ...
        for indices in combinations_with_replacement(range(0, n), 3):
          ...
          signs = PP.signs[:indices[0]+1] + \
                      PP.signs[indices[1]+2:indices[2]+3] + \
                      PegPermSet.flip_signs(PP.signs[indices[0]+1:indices[1]+2][::-1]) + \
                      PP.signs[indices[2]+3:]
          ...
          signs = PP.signs[:indices[0]+1] + \
                      PegPermSet.flip_signs(PP.signs[indices[1]+2:indices[2]+3][::-1]) + \
                      PP.signs[indices[0]+1:indices[1]+2] + \
                      PP.signs[indices[2]+3:]
